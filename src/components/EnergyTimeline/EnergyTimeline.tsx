        ...
        <header className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          ...
          <div className="relative">
            <button 
              ...
              className="flex items-center space-x-2 bg-gray-800 text-white px-3 py-2 rounded-lg 
                       hover:bg-gray-700 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 text-sm border border-gray-700"
            >
              ...
              {interactions.showCalendar && (
                <div className="absolute top-full mt-2 right-0 bg-gray-800 rounded-lg p-4 shadow-xl z-timeline-calendar min-w-[260px] border border-gray-700">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-sm font-medium text-white">Select Date</h3>
                    <button 
                      onClick={() => interactions.setShowCalendar(false)}
                  ...
                  <input
                    ...
                    className="w-full bg-gray-700 text-white px-3 py-2.5 rounded-lg border border-gray-600 
                  ...
                  <div className="mt-3 flex space-x-2">
                    <button 
                      ...
                      className="flex-1 bg-blue-600 text-white px-3 py-2 rounded-lg text-xs font-medium
                               hover:bg-blue-700 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200"
                    >
                      Today
                    </button>
                    <button 
                      ...
                      className="flex-1 bg-gray-700 text-white px-3 py-2 rounded-lg text-xs font-medium
                               hover:bg-gray-600 focus:ring-2 focus:ring-gray-500/20 transition-all duration-200"
                    >
                      Yesterday
                    </button>
                  </div>
              ...
              {highlights.map((highlight, index) => {
                ...
                return (
                  <div
                    ...
                    >
                      <div 
                        className="px-3 py-1.5 text-xs font-medium text-white shadow-sm flex items-center space-x-1"
                        style={{ 
